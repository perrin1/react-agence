...
const Footer = () => {
  return (
    <footer className=" bg-cyan-950 w-full" aria-labelledby="footer-heading">
      <h2 id="footer-heading" className="sr-only">
        Footer
      </h2>
      <div className="mx-auto max-w-7xl px-6 pb-8 pt-16 sm:pt-6 lg:px-8 lg:pt-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <div className="flex space-x-6">
              ...
              <a href="#" className="text-white hover:text-blue-4      00">
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-3  gap-8 xl:col-span-2 xl:mt-0">
            <div className="mt-10 md:mt-0">
              ...
              <ul role="list" className="mt-6 space-y-4">
                <li>
                  <a
                    href="#"
                    className="text-md leading-6 text-gray-100 hover:underline "
                  >
                    Pricing
                  </a>
                </li>
            ...
            <div className="mt-10 md:mt-0">
              ...
              <ul role="list" className="mt-6 space-y-4">
                <div>
                  <input
                    className="border-2 border-gray-300 bg-white h-10 px-5 pr-' rounded-lg text-md focus:outline-none"
                    type="search"
                    name="search"
                    placeholder="Search"
                  />
